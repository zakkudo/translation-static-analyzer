...
module.exports = class TranslationStaticAnalyzer {
    /**
     * @param options - The modifiers for how the analyzer is run
     * @param options.files - A glob of the files to pull translations from
     * @param options.debug - Show debugging information in the console
     * @param options.locales - The locales to generate (eg fr, ja_JP, en)
     * @param options.target - Where to write the final translations, which can be split between
